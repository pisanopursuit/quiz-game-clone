...
function buildScoreboard(){
	...
	$('#buttonSubmit').click(function(){
		...
		if(gameData.type == 'quick'){
			...
			submitUserScore(categoryTableSettings.categoryName, userScore);
		}
	});
...
function toggleSaveButton(con){
	if(!scoreboardSettings.displayScoreBoard){
		...
		$('.resultContent .optionScore').removeClass('singleOption');
	}
	
	if(con){
		$('.resultContent .optionScore').removeClass('NoSaveOption');
	}else{
		$('.resultContent .optionScore').addClass('NoSaveOption');
	}
}
			...
			if(categorySettings.status){
				if(gameData.page == 'result'){
					if(gameData.type == 'quick'){
						...
						scoreListsData.category = categoryTableSettings.categoryName;
					}
				}
			}
			loadScoreboard();
